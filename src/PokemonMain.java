...
public class PokemonMain {
    public static void main(String[] args) {
        ...
        System.out.println(usePokemonAgainst(pokemonListOfAsh, wildPokemon));
    }

    public static String usePokemonAgainst(List<Pokemon> defenders, Pokemon attacker) {
        for (Pokemon item: defenders) {
            if (item.isEffectiveAgainst(attacker))
                return item.name;
        }
